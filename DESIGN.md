...
**The Operational Context Rule.** Land and water remain the base plane beneath radar. Local streets, buildings, railways, water names, and secondary places also stay below radar. Only major routes, boundaries, and important place labels remain above it with enough light-and-dark contrast to survive changing radar colors. Split water polygons are never outlined as persistent context because their generated seams and generalized geometry change across zoom levels. Global radar opacity is not used to make the map visible, and context is never allowed to become a luminous wireframe.
