...
**Active change:** Focused National playback visual-fidelity correction: prepare the finest complete all-frame regional viewport level before playback, preserve uniform quality through camera moves, and keep the prior paint visible during bounded preparation
