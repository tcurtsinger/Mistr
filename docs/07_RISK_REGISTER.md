...
| R31 | Palette styling hides weak returns or visually overstates reflectivity | Medium | High | Clear-air structure disappears or ordinary rain shifts into yellow/red too early | Preserve every valid raw code; pin NOAA/NWS operational `SR_BREF` five-dBZ anchors and opaque valid-pixel behavior; exhaustive 256-entry tests | Mitigated for Alpha reflectivity palette |
