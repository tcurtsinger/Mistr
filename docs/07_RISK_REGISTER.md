...
| R31 | A display threshold hides valid weak reflectivity returns | Medium | High | Clear-air structure disappears or code 2 becomes transparent | Preserve every valid raw code; restrained nonzero low-return alpha; gradual monotonic palette; exhaustive 256-entry tests | Mitigated for Alpha reflectivity palette |
