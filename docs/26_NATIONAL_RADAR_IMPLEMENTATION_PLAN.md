...
- newest-first paint and bounded predecessor backfill, with the unconsumed candidate retried through capped jitter/backoff after a transient failure;
