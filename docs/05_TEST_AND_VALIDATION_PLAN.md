...
11. A forced Site failure after it cancels National must preserve the old National paint, start a newer National generation, and restore matching backend, renderer, coordinator, and transfer ownership before the normal successful Site handoff.
